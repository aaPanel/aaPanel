var lan = {
	...
	"bt":{
		...
		"insatll_mem":"Your memory is less than {1}, NOT recommended to install MySQL-{2}",
	...
	"site":{
		...
		"add_site":{
			...
			"bath_tips1":"Batch format: Domain|Root directory|FTP|Database|PHP version",
			"bath_tips2":"<span style='padding-top:5px;display:inline-block;'>Domain format: domains use &nbsp;,&nbsp; spilt</span>",
			"bath_tips3":"Root directory: Input&nbsp;1&nbsp;is automatic creation, or enter a specific directory",
	...
	"public_backup":{
		...
		"cp_success":"Successfully copied",
		"cp_fail":"Failed to copy, browser is not compatible!",
		"bind_bt_account":"Bind Account registered",
		"mobile_phone":"Mobile phone",
		"mobile_phone_or_email":"Mobile phone or Email",
		"pass":"Password",
