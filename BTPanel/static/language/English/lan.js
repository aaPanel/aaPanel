var lan = {
	...
	"files":{
		...
		"unfavorite":"Unfavorite, please wait...",
	...
	"soft":{
		...
		"php_fpm_ps3":"Initial processes (Num of initial processes when server starts)",
		...
		"menu_phpsafe":"PHP Daemon turned on, no need to configurates",
		...
		"install_third_party_apps":"Install third-party plugin packages",
	...
	"site":{
		...
		"config_url":"Configurates rewrite rules",
		...
		"bt_ssl_help_3":"aaPanel SSL apply certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for aaPanel users!",
        ...
        "independent_storage": "If turn on, the session file will be stored in a separate folder, not shared with other sites.",
        ...
        "ssl_tips2": "aaPanel SSL applies for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
	...
	"pgsql":{
		...
		"whether_del_import_file":"Are you sure to delete the &nbsp;[{1}]&nbsp;imported file?",
	...
	"one_click":{
		...
		"domain_format_err":"Domain address format is incorrect, re-enter please",
