var lan = {
	...
	"config": {
		...
		"binding_un": "Bind",
		"ssl_close_msg": "You will have to use http protocol to visit Panel after turning off SSL, continue?",
		...
		"ssl_open_ps_2": "Panel SSL is a Self Signed SSL，browsers will display error or risk, this is Normal",
	...
	"bt": {
		...
		"install_type": "Method",
		"install_rpm": "Fast",
		"install_rpm_title": "rpm, installing in a very short time (5~10 minutes), with performance and stability lower than compiled",
	...
	"soft": {
		...
		"php_fpm_ps3": "Num of init processes (Initiatial processes when server starts)",
		"php_fpm_ps4": "Min of free processes (Kept progress after cleaning progress task)",
		"php_fpm_ps5": "Max of free processes (Start clean progress task when reach this value)",
	...
	"site": {
		...
		"parsed_info": "For reference only, users using CDN please ignore",
