...
define('public/vdom', ['require', 'exports', 'snabbdom'], function (require, exports, snabbdom_1) {
    ...
    var Vm = (function () {
        ...
        Vm.prototype.$ul = function (config, arry) {
            ...
            return (0, snabbdom_1.jsx)('ul', {
                class: this.$class('help-info-text c7 '.concat(className || '')),
        ...
        Vm.prototype.$line = function (config, content) {
            ...
            return (0, snabbdom_1.jsx)(
                ...
                (0, snabbdom_1.jsx)('span', {
                    class: {tname: true},
                    style: this.$style(''.concat(width ? 'width:' + width + ';' : '').concat(style))
                }, title),
        ...
        Vm.prototype.$switch = function (config) {
            ...
            return (0, snabbdom_1.jsx)(
                ...
                (0, snabbdom_1.jsx)('label', {
                    style: {position: 'relative', top: '5px'},
                    class: {'btswitch-btn': true},
                    props: {htmlFor: model + '_vm'}
                })
            );
        };
        ...
        Vm.prototype.$select = function (config) {
            ...
            var optionList = options.map(function (item, index) {
                ...
                return (0, snabbdom_1.jsx)('option', {
                    key: index,
                    props: {value: item.value, selected: item.value === value}
                }, item.label);
            });
            return (0, snabbdom_1.jsx)(
                'select',
        ...
        Vm.prototype.$textarea = function (config) {
            ...
            return (0, snabbdom_1.jsx)(
                'textarea',
                {
                    class: this.$class('bt-input-text '.concat(className || '')),
                    style: this.$style(style),
                    props: {name: name, id: id},
                    on: {input: this.$inputEvent.bind(this)}
                },
                value
            );
        };
        ...
        Vm.prototype.$link = function (config) {
            ...
            return (0, snabbdom_1.jsx)(
                'a',
                {
                    class: this.$class('btlink ' + className),
                    props: {href: href || 'javascript:;', target: target || '_blank'},
                    style: this.$style(style),
                    on: {click: click}
                },
                title
        ...
        Vm.prototype.$icon = function (config) {
            var click = config.click,
                style = config.style,
                type = config.type;
            return (0, snabbdom_1.jsx)('span', {
                class: this.$class('glyphicon glyphicon-'.concat(type, ' cursor')),
                style: this.$style(style),
                on: {click: click}
            });
        };
        ...
        Vm.prototype.$learnMore = function (config) {
            ...
            return (0, snabbdom_1.jsx)(
                'div',
                {
                    class: this.$class('mt10 agreementBox '.concat(className || '')),
                    props: {id: id},
                    style: this.$style(style)
                },
                (0, snabbdom_1.jsx)(
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4, this.$confirm({
                                            title: 'Tips',
                                            msg: 'Panel login has expired, please login again!'
                                        })];
                                    case 1:
                                        _a.sent();
                                        layer.closeAll();
...
define('public/public', ['require', 'exports', 'snabbdom', 'public/utils'], function (require, exports, snabbdom_2, utils_1) {
    ...
    var Public = (function (_super) {
                    ...
                    template: function () {
                        return (0, snabbdom_2.jsx)(
                            ...
                            (0, snabbdom_2.jsx)('div', {class: {line: true}}, this.$input({
                                model: 'username',
                                placeholder: lan.public.user
                            })),
                            (0, snabbdom_2.jsx)('div', {class: {line: true}}, this.$input({
                                model: 'password',
                                type: 'password',
                                placeholder: lan.public.pass,
                            ...
                            (0, snabbdom_2.jsx)('p', {class: {'text-right': true}}, ' ', this.$link({
                                title: lan.public_backup.no_account,
                                href: 'https://www.aapanel.com/user_admin/register'
                            }))
                        );
                    },
                    methods: {
        ...
        Public.prototype.getFileList = function (path, type) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var _this, diskHtml, fileHtml, dirHtml, rdata, fileList, dirList, diskList, i_1, item, i_2, item,
                    unfoldList, dirName, i, item, unfoldList, fileName;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.trys.push([1, 6, , 7]);
                                                            return [4, this.$confirm({
                                                                title: 'Delete Email ['.concat(email, ']'),
                                                                msg: 'Are your sure to delete the Email?'
                                                            })];
                                                        case 2:
                                                            _a.sent();
                                            ...
                                            return __awaiter(_this_1, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.sent();
                                                            return [4, this.$request('setTelegramConfig', {
                                                                my_id: id_1,
                                                                bot_token: token_1
                                                            })];
                                                        case 2:
                                            ...
                                            return __awaiter(_this_1, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.sent();
                                                            return [4, this.$request('setDingDingConfig', {
                                                                title: name_2,
                                                                url: url,
                                                                atall: 'True'
                                                            })];
                                        ...
                                        return __awaiter(_this_1, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                ...
                                                $('.SetChannelEmail').click(function () {
                                                    return __awaiter(_this_1, void 0, void 0, function () {
                                                        var email, stmp_pwd, hosts, port, portSelectVal, rdata, text,
                                                            type;
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                ...
                                                                case 1:
                                                                    _a.sent();
                                                                    return [4, this.$request('setMailConfig', {
                                                                        email: email,
                                                                        stmp_pwd: stmp_pwd,
                                                                        hosts: hosts,
                                                                        port: port
