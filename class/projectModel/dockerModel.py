...
class main :#line:15
    ...
    def model (O0O0OOO0OO0OO00OO ,OO0O0O000O00O00O0 ):#line:20
        ...
        try :#line:40
            ...
            if not re .match (r"^\w+$",OO0O0O000O00O00O0 ['mod_name']):return public .return_status_code (1000 ,'The called module name cannot contain characters other than \w')#line:46
            if not re .match (r"^\w+$",OO0O0O000O00O00O0 ['def_name']):return public .return_status_code (1000 ,'The called module name cannot contain characters other than \w')#line:47
        except :#line:48
