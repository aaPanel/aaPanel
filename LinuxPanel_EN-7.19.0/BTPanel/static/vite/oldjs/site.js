			...
			$('#webedit-con').html(
				'<div class="warning_info mb10 ' +
					...
					lan.site.set_ssl.tips2(
						'<span class="ellipsis_text" style="display: block;max-width: 164px;width: auto;" title="' +
					...
					'<button class="btn btn-success btn-xs renewCertificate" style="margin-left: 16px;" data-type="' +
					rdata.type +
					'">' +
