...
def get_user_info():
    ...
    try:
        ...
        userInfo['uid'] = userTmp['id'] if userTmp.get('id', None) else userTmp['uid']
        userInfo['address'] = userTmp['last_login_ip']
        userInfo['access_key'] = 'B' * 32,
        userInfo['username'] = userTmp['username']
        userInfo['server_id'] = userTmp['server_id']
        userInfo['serverid'] = userTmp['server_id']
