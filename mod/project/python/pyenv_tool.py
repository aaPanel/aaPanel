...
""" + res_sh
    ...
    def remove(self) -> Optional[str]:
        if self.env_type == "conda":
            ...
            return public.lang("Python environments not installed or created by the aaPanel are not supported,"
    ...
    def multi_remove_env(self, *more_path: str) -> List[Dict]:
        ...
        for p in to_remove:
            if p.env_type == "conda":
                ...
                res_map[p.bin_path].update(
                    status=False,
                    msg="This Python environment wasn't installed/created by the aaPanel and can't be managed here. "
